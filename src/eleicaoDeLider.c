    ...
    while (time() < MaxTempoSimulac) {
        ...
        switch (event) {
            ...
            case ELEICAO_DE_LIDER:
                ...
                if ((ret == 1) && (recMsg.epoch > processo[token].epoch)) {
