...
-1 (unknown), 0 (correto) ou 1 (falho). Inicialize (para todos os processos)
o State[N] com -1 (indicando estado “unknown”) para todos os demais processos
e 0 para o próprio processo. Nesta tarefa ao executar um teste em um processo j,
o testador atualiza a entrada correspondente no vetor State[j]. Em cada intervalo
...
int main(int argc, char *argv[]) {
	...
	puts("      Cada processo mantém localmente os estados de cada processos: \n -1 (unknown), 0 (correto) ou 1 (falho).");
